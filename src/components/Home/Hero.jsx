...
const Hero = () => {
  ...
  return (
    <div className=" lg:h-[140vh] bg-[#edf3fe]">
      {/* Navigation  */}
      <div className="flex w-full justify-between items-center bg-[#08225A] lg:h-[333px] py-[20px] px-[5rem]">
            ...
            <div className="flex items-center gap-[40px]">
              ...
              <ul className="hidden lg:flex items-center gap-[40px] text-[16px] font-medium text-[#FFFFFF]">
                <Link href={"/"} className=" flex flex-col items-center">
                  <p>Home</p>
                  <div
                    className={`w-[60px] h-[4px] bg-blue-800 md:block hidden ${pathName === "/" ? "block" : "hidden"
                      }`}
                  ></div>
                </Link>
                <Link href={"/buy"} className=" flex flex-col items-center">
                  <p>Buy</p>
                  <div
                    className={`w-[60px] h-[4px] bg-blue-800 hidden ${pathName === "/buy" ? "block" : "hidden"
                      }`}
                  ></div>
                </Link>
                <Link href={"/sell"} className=" flex flex-col items-center">
                  <p>Sell</p>
                  <div
                    className={`w-[60px] h-[4px] bg-blue-800 hidden ${pathName === "/sell" ? "block" : "hidden"
                      }`}
                  ></div>
                </Link>
