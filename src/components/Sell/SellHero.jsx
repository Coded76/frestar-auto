...
const SellHero = () => {
  ...
  return (
    <div className="w-full flex items-center flex-col justify-center px-[40px]">
      {/* Navigation */}
      ...
      <div className="w-full  relative lg:top-[-14rem] flex items-center flex-col justify-center px-[40px]">
        <div className="w-full bg-[#3B82F6] rounded-4xl">
          <div className="bg-[url(/sell.svg)] bg-cover bg-center w-full h-[800px] rounded-4xl flex items-end justify-start p-[5rem]">
