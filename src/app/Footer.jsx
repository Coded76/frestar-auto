        ...
        <div className="flex justify-between gap-8 mb-6">
          <div className="w-[496px] flex flex-col gap-[20px]">
            <img
              src="/logo.svg"
              alt="Frestar Logo"
              className="h-8 w-[198.5px] mb-4"
            />
            <p className="w-[496px] font-light text-[16px] leading-[24px]">
              Frestar Digital is authorised and regulated by the Central Bank of
              Nigeria to offer banking services. Deposits are insured by the
